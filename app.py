...
def signup():
    ...
    # extracing user inputs from a form
...
def addproducts():
    ...
    # extracting the filename from the product photo

    filename=product_photo.filename

    # specify the path to our static folder that contains images folder

    photopath=os.path.join(app.config["UPLOhttp://127.0.0.1:5000/api/addproductsAD_FOLDER"],filename)
...
def mpesa_payment():
    ...
    # Extract POST Values sent
        ...
        "AccountReference": " Kelvin ataga enterprise Online",
